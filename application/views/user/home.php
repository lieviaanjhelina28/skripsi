    ...
    <section id="featured-services" class="featured-services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <!-- <div class="col-lg-6 col-md-4 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              <div class="icon"><i class="bx bx-file"></i></div>
              <h4 class="title"><a href="">Petunjuk</a></h4>
              <p class="description">
                1. Pilih Menu Diagnosis<br>
                2. Pilih Gejala<br>
                3. Klik Diagnosisi
              </p>
            </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="">Sistem Pakar</a></h4>
              <p>Sistem Pakar merupakan sebuah sistem yang dirancang berbasis komputer dengan menggunakan pengetahuan, fakta dan cara berfikir seorang pakar dalam menyelesaikan suatu masalah yang biasanya hanya dapat diselesaikan oleh pakar</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-file"></i></div>
              <h4><a href="<?php echo base_url('home/macam') ?>">Tanaman Pisang</a></h4>
              <p>Tanaman Pisang merupakan tanaman asli asia tenggara termasuk indonesia. tanaman pisang tanaman yang dapat ditanaman diperkarangan rumah maupun di perkebunan. Terdapat beberapa penyakit yang dapat menyerang tanaman pisang diantaranya:</p>
               <a href="<?php echo base_url('home/macam') ?>" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-search fa-sm text-black-50"></i> Penyakit Tanaman Pisang</a>
            </div>
          </div>
